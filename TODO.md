...
2. Better system for which meshes to render and which pipeline is available
3. Object and Level Serializer and Deserializer
4. Change Window class backend to be SDL2/3
5. Change math library to Eigen3 
6. Better Implementation of Lights
